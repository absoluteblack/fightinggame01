...
if(image_index >= 4){image_index=2; }
	...
	hitbox = hitbox_create(32*image_xscale, 32, 16*image_xscale, -1, 8, (charge_timer*.2)*image_xscale, (charge_timer*.4), 55); //3rd to last and 2nd to last xknockback and yknockback
	hitbox_created = true;}
	}
